...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-v-k6-c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-v-k6-c.containers.anotherwebservice.com/
...
```
git clone git@github.com:GadzhetLak/container-v-k6-c.git
cd container-v-k6-c
```
...
```
docker attach container-v-k6-c
```
